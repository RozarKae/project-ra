...
import { useGuests, useActivityLogs, useWorkspace } from '@project-ra/shared';
...
export const Dashboard: React.FC = () => {
  ...
  const handleExportList = () => {
    ...
    const headers = ['Name', 'Phone', 'Side', 'RSVP Status', 'Family Group', 'Notes'];
    const rows = guests.map(g => [g.name, g.phone || '', g.side.toUpperCase(), g.rsvpStatus.toUpperCase(), g.familyName || '', g.notes || '']);
