...
import { Button, Card, Modal } from '@project-ra/ui';
import { Guest, ActivityLog } from '@project-ra/types';
import { GuestProfileView } from './GuestProfileView';
import { toast } from 'react-hot-toast';
import { useGuests, useWorkspace, ActivityRepository, useActivityLogs } from '@project-ra/shared';
import { useAuth } from '@project-ra/firebase';
import { 
  checkPotentialDuplicate, 
  getSimilarity, 
  getPhoneticSimilarity 
} from '@project-ra/utils';
...
export const Guests: React.FC = () => {
  ...
  const handleSave = async (e: React.FormEvent, addAnother = false, forceSave = false) => {
    ...
    // Pre-save smart duplicate checker
  ...
  return (
    <div className="space-y-8 font-poppins relative">
      ...
      {/* Family Sections Accordion Grid list */}
      ...
      >
        {isReadOnly && selectedGuest ? (
          ...
          <div>
            ...
            {/* Live Duplicate Suggestions Panel */}
