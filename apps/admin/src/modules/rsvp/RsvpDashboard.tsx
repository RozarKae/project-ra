...
import { Card, Button, Modal, Table } from '@project-ra/ui';
import StatCard from '../../components/dashboard/StatCard';
import { toast } from 'react-hot-toast';
import { useGuests } from '@project-ra/shared';
...
export const RsvpDashboard: React.FC = () => {
  ...
  const chartSlices = [
    { value: acceptedInvites, color: '#D4AF37', label: 'Accepted' },
    { value: declinedInvites, color: '#F43F5E', label: 'Declined' },
    { value: maybeInvites, color: '#F59E0B', label: 'Maybe' },
    { value: pendingInvites, color: '#3F3F46', label: 'Pending' }
  ];
  ...
  const points = trendData.map((d, index) => {
    ...
    const y = 80 - (d.count / maxTrendVal) * 60;
    return { x, y, ...d };
  });
