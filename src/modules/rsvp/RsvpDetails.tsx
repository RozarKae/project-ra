...
import { RsvpEntry, RsvpTimelineEvent } from '../../repositories/RsvpRepository';
...
export const RsvpDetails: React.FC = () => {
  ...
  return (
    <div className="space-y-8 font-poppins relative">
      ...
      {/* Roster Table card - Desktop / Adaptive Mobile cards layout */}
      <Card className="p-0 border border-[#D4AF37]/10 overflow-hidden">
        ...
        {/* Mobile View Roster (Expandable Cards) */}
