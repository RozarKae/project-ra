...
export const UserProfile: React.FC = () => {
  ...
  // Check if form is dirty (unsaved modifications exist)
  ...
  const handlePhotoSelect = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files && e.target.files[0]) {
      ...
      if (validatePhoto(file)) {
        setPhotoFile(file);
        setPhotoURL(URL.createObjectURL(file)); // preview link
      }
    }
  };
  ...
  // File Upload Helper (Uploads to Storage or falls back to Base64 dataURIs offline)
    ...
    <div className="space-y-8 font-poppins relative">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          ...
          {/* Card 4: Security (Password Modification) */}
          <Card className="p-5 border border-[#D4AF37]/10 space-y-4">
            <div className="flex items-center gap-2 border-b border-[#D4AF37]/5 pb-3 mb-2">
